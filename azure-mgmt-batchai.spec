...
License  : MIT
Requires: azure-mgmt-batchai-python = %{version}-%{release}
Requires: azure-mgmt-batchai-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-batchai package.
Group: Default
Requires: azure-mgmt-batchai-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-batchai package.


%package python3
Summary: python3 components for the azure-mgmt-batchai package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_batchai)
Requires: pypi(azure_common)
Requires: pypi(azure_mgmt_nspkg)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-batchai package.


%prep
%setup -q -n azure-mgmt-batchai-2.0.0
cd %{_builddir}/azure-mgmt-batchai-2.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588788540
